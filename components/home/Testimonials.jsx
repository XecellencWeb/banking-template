...
import testomonial1 from "/public/company/1.jpeg";
import testomonial2 from "/public/company/2.jpeg";
import testomonial3 from "/public/company/3.jpeg";
import testomonial4 from "/public/company/4.jpeg";
import { site_name } from "../../data/names";
            ...
            <Slider {...settings} className="testimonials-carousel">
              <div className="slide-item">
                <div className="single-slide">
                  <div className="thumb">
                    <Image src={testomonial1} alt="image" className="max-un" />
                  </div>
                  <div className="content">
                    <div className="top-content">
                      <Image src={quote} alt="quote" />
                      <h5>“I love {site_name}, they&#39;re the best”</h5>
                      <p className="xxlr">
                        “ It&#39;s been 2 years since I found {site_name}, and
              ...
              <div className="slide-item">
                <div className="single-slide">
                  <div className="thumb">
                    <Image src={testomonial2} alt="image" className="max-un" />
                  </div>
                  <div className="content">
                    <div className="top-content">
                      <Image src={quote} alt="quote" />
              ...
              <div className="slide-item">
                <div className="single-slide">
                  <div className="thumb">
                    <Image src={testomonial3} alt="image" className="max-un" />
                  </div>
                  <div className="content">
                    <div className="top-content">
                      <Image src={quote} alt="quote" />
              ...
              <div className="slide-item">
                <div className="single-slide">
                  <div className="thumb">
                    <Image src={testomonial4} alt="image" className="max-un" />
                  </div>
                  <div className="content">
                    <div className="top-content">
                      <Image src={quote} alt="quote" />
