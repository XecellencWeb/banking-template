            ...
            <nav className="navbar navbar-expand-lg navbar-light">
              ...
              >
                ...
                <div className="right-area header-action d-flex align-items-center">
                  {auth.currentUser?<div className="bottom-area">
                    <Link href="/account" className="cmn-btn">
                      Your Account
                    </Link>
                  <Link onClick={(e)=>{
                    e.preventDefault()
                    ...
                    navigate.replace('/')
                  }} style={{marginLeft: '1rem'}} href="#" className="cmn-btn second">
                      Log Out
                    </Link>
                  </div>:<div className="bottom-area">
                  <Link href="/login" className="cmn-btn second">
                      Log In
                    </Link>
                    <Link style={{marginLeft: '1rem'}} href="/register" className="cmn-btn">
                      Open Account
                    </Link>
                  </div>}
                </div>
