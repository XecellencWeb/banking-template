import { support_number } from "./names";
...
const faqData = [
  {
    ...
    answer:
      `If your card is missing, let us know immediately. We’ll block your card right away send over a new one on the same day.To report a lost or stolen card, call us at ${support_number}.`,
  },
  {
    id: 2,
